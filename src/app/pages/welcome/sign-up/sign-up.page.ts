...
export class SignUpPage implements OnInit {
  ...
  constructor(
    ...
    private actionSheetController: ActionSheetController,public fireService:FireserviceService,public router:Router
    // private file: File
  ) { 
    this.initForm();
  }
  ...
  signup() {
      ...
      this.fireService.signup({email:this.form.value['email'],password:this.form.value['password']}).then(res=>{
